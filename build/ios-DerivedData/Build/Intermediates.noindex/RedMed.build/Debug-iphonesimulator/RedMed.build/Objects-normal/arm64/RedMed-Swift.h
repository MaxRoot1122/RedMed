...
#ifndef REDMED_SWIFT_H
#define REDMED_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RedMed",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// hopped to main.
SWIFT_CLASS("_TtC6RedMed15LocationManager")
...
@class CLLocation;
@class CLHeading;
@interface LocationManager (SWIFT_EXTENSION(RedMed)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC6RedMed9NFCReader")
...
@protocol NFCNDEFTag;
@interface NFCReader (SWIFT_EXTENSION(RedMed)) <NFCNDEFReaderSessionDelegate>
...
SWIFT_CLASS("_TtC6RedMed9NFCWriter")
@interface NFCWriter : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface NFCWriter (SWIFT_EXTENSION(RedMed)) <NFCNDEFReaderSessionDelegate>
- (void)readerSession:(NFCNDEFReaderSession * _Nonnull)session didDetectNDEFs:(NSArray<NFCNDEFMessage *> * _Nonnull)messages;
- (void)readerSession:(NFCNDEFReaderSession * _Nonnull)session didDetectTags:(NSArray<id <NFCNDEFTag>> * _Nonnull)tags;
- (void)readerSession:(NFCNDEFReaderSession * _Nonnull)session didInvalidateWithError:(NSError * _Nonnull)error;
@end
