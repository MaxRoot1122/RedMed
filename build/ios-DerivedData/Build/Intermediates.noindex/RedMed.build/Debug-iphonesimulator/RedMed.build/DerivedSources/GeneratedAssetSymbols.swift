...
extension ImageResource {
    ...
    /// The "BrandWordmark" asset catalog image resource.
    static let brandWordmark = ImageResource(name: "BrandWordmark", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "BrandWordmark" asset catalog image.
    static var brandWordmark: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .brandWordmark)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "BrandWordmark" asset catalog image.
    static var brandWordmark: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .brandWordmark)
#else
        .init()
