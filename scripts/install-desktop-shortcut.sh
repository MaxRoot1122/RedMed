...
APP_REAL="${REPO_ROOT}/ios/RedMed.app"
...
GIT_REMOTE="$(git -C "$REPO_ROOT" remote get-url origin 2>/dev/null || echo "https://github.com/RedmMed/RedMed.git")"
{
  cat <<'DESKTOP_README'
RedMed — iOS build is the priority

GitHub: https://github.com/RedmMed/RedMed
Clone:  git clone https://github.com/RedmMed/RedMed.git
